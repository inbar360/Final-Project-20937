...
def handle_one_param(server, client_id: bytes, code: int, unpacked_payload) -> ReqState:
    """
...
def handle_sending_public_key(server, client_id: bytes, code: int, unpacked_payload: tuple) -> ReqState:
    """
...
def handle_sending_file(server, client_id: bytes, code: int, unpacked_payload: tuple) -> ReqState:
    """
...
def crc_requests(server, client_id: bytes, code: int, file_name: str) -> ReqState:
    """
